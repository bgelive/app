function getUsernameFromLocalStorage() {
  return localStorage.getItem('bgelocal');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbz1uo7YQx_2PmNklmcN8yG4cQeLoJyAznrH9wiWfW-jYTmFS63k0RODl89rQeaTBWWIsw/exec';
