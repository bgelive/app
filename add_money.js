const username = localStorage.getItem('bgelocal');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwpvgNoGDYKUqC6RlgX9JCQJOHDtTHSYgcOfvSRD0kbVBCtcOMkI_MsDI-TaPIsls7hFg/exec';
...
async function uploadToImgur(file) {
    ...
    const response = await fetch('https://api.imgur.com/3/image', {
        method: 'POST',
        headers: {
            'Authorization': 'Client-ID 0448995cc69d317'
        },
        body: formData
    });
