const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwNZwecVqEdewPdhy3lEHijARo_QUInzjgHjtBFAmvIqMnAK6yGWb5Y_1KAdIKv5meTDQ/exec";
...
async function submitData() {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            localStorage.setItem('bgelocal', formData.username);
